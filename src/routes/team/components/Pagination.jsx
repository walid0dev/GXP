...
const Pagination = () => {
  ...
  const setPage = useGameDevTeamStore((state) => state.setPage);
  const prevPage = useGameDevTeamStore((state) => state.prevPage);
  const nextPage = useGameDevTeamStore((state) => state.nextPage);
  ...
  return (
    <nav
      ...
      aria-label="Development team pagination controls"
    >
