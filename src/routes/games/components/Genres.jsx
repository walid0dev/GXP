...
export default function Genres() {
  ...
  return (
    <div className="my-12 flex flex-wrap items-start gap-3">
      ...
      <div className="flex gap-4 flex-wrap items-center *:basis-1/6 justify-center ">
        {genres.map((genre) => (
          <button
            ...
            className={`cursor-pointer text-center rounded-full border px-4 py-2 text-sm font-medium transition-all duration-200 ${
              genre.isActive
